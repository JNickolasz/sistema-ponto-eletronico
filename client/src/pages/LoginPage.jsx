            ...
            <div className="mt-8 pt-6 border-t border-slate-800">
              ...
              <div className="space-y-2">
                ...
                <button
                  ...
                  className="w-full text-left rounded-xl bg-slate-950/80 hover:bg-slate-800/80 border border-slate-800 hover:border-amber-500/50 p-2.5 transition-all cursor-pointer group"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                      <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-amber-500/20 text-amber-400 text-xs font-bold">
                        ADM
                      </span>
                      <div>
                        ...
                        <div className="text-[11px] text-slate-500 font-mono">
                          Chave Mestra: admin123 (Cadastro de Empresas)
                        </div>
                      </div>
                    </div>
                    <span className="text-[11px] text-amber-400 font-medium opacity-0 group-hover:opacity-100 transition-opacity">
                      Preencher →
                    </span>
                  </div>
                </button>
